...
public class Choose_Tank2 implements Screen, Serializable {
    protected Vector3 mouse;

    private final Texture background;
    private final TankStars game;
    public Choose_Tank2(TankStars game){
        this.game=game;
        background=new Texture("Choose2_1.png");
        mouse=new Vector3();
    }
    @Override
    public void show() {
        ...
        if(Gdx.input.justTouched()) {
            if (Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
                ...
                if (mouse.y > 320 && mouse.y < 385) {
                    ...
                    game.setScreen(new Choose2_Tank1(this.game,2));
                    dispose();
                }
            }
        }
